...
namespace PetFamily.Accounts.Infrastructure.Migrations
{
    ...
    [Migration("20250519163534_Initial")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("PetFamily.Accounts.Domain.Accounts.AdminAccount", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid")
            ...
            modelBuilder.Entity("PetFamily.Accounts.Domain.Accounts.ParticipantAccount", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid")
            ...
            modelBuilder.Entity("PetFamily.Accounts.Domain.Accounts.VolunteerAccount", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid")
            ...
            modelBuilder.Entity("PetFamily.Accounts.Domain.RefreshSession", b =>
                {
                    ...
                    b.ToTable("refresh_session", "PetFamily_Accounts");
                });
            ...
            modelBuilder.Entity("PetFamily.Accounts.Domain.Accounts.AdminAccount", b =>
                {
                    b.HasOne("PetFamily.Accounts.Domain.User", "User")
                        ...
                        .HasForeignKey("PetFamily.Accounts.Domain.Accounts.AdminAccount", "UserId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired()
            ...
            modelBuilder.Entity("PetFamily.Accounts.Domain.Accounts.ParticipantAccount", b =>
                {
                    b.HasOne("PetFamily.Accounts.Domain.User", "User")
                        ...
                        .HasForeignKey("PetFamily.Accounts.Domain.Accounts.ParticipantAccount", "UserId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired()
